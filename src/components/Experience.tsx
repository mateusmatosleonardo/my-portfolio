export function Experience() {
  return (
    <div className="container mx-auto mt-48">
      <p className="text-[0.955rem] text-dark_primary text-center mb-8">Experiência</p>
      ...
      <div className="w-full max-w-[1024px] mx-auto flex flex-col sm:flex-row gap-x-6 lg:gap-x-0 px-2 sm:px-0">
        <div className="w-full flex">
          <div className="flex flex-col gap-y-[72px] w-[50%]">
            <div>
              <p className="text-[0.955rem] text-white">Barato Coletivo (Remoto)</p>
              <p className="text-[0.855rem] text-[#5F5F5F]">
                1 ano e 6 meses (2023-2024)
              </p>
            </div>
            <div>
              <p className="text-[0.955rem] text-white">C3C Software (Remoto)</p>
              <p className="text-[0.855rem] text-[#5F5F5F]">1 ano (2022-2023)</p>
            </div>
            <div>
              <p className="text-[0.955rem] text-white">Grupo Arkos (Remoto)</p>
              <p className="text-[0.855rem] text-[#5F5F5F]">9 meses (2021-2022)</p>
            </div>
            <div>
              <p className="text-[0.955rem] text-white">Freelancer</p>
              <p className="text-[0.855rem] text-[#5F5F5F]">2 anos (2019-2021)</p>
            </div>
          </div>
          <div className="w-[50%]">
            <div className="flex">
